package cn.edu.ahau.base.response;
...
public abstract class ResponseUtil {
    ...
    public static ResponseData error(Integer code,String msg) {
        return instance( ResponseData.RESULT_STATUS_ERROR, code, msg,new JSONObject());
    }
    ...
    public static ResponseData fail(Integer code,String msg) {
        return instance( ResponseData.RESULT_STATUS_FAIL, code, msg,new JSONObject());
    }
